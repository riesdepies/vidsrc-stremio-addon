...
// Headers worden nu grotendeels beheerd door got-scraping, maar we kunnen nog steeds een referer meesturen.
...
// --- PROXY FUNCTIE IS VERWIJDERD ---
// We gebruiken nu gotScraping direct, wat de proxy overbodig maakt.
...
async function searchDomain(domain, apiType, imdbId, season, episode, controller, visitedUrls) {
    ...
    for (let step = 1; step <= MAX_REDIRECTS; step++) {
        ...
        try {
            // Gebruik gotScraping in plaats van fetchViaProxy
            const response = await gotScraping({
                ...
                retry: { limit: 0 } // Voorkom dat gotScraping zelf gaat retryen
            });
